...
function fetchBookmarks(){
	...
	for( var i=0; i < bookmarks.length; i++){
      ...
      // += means adding to bookmarksResults.innerHTML set above as empty
		bookmarksResults.innerHTML += ' <div class="well" > <h4> '+"<span>&nbsp;</span>"+name+'<span>&nbsp;</span>'+'<a class="btn btn-xs btn-primary"  href="'+url+'">Visit</a> <a  onclick="deleteBookmark(\''+url+'\')" class="btn btn-xs btn-danger" href="#">Delete</a></h4>'+'</div>';
	}
